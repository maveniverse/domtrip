...
public class ImprovedApiDemo {
    ...
    private static void demonstrateFactoryMethods() {
        ...
        Element dependency = Elements.elementWithAttributes("dependency", 
            Map.of("scope", "test", "optional", "true"));
    ...
    private static void demonstrateEnhancedNavigation() {
        ...
        root.findChild("dependencies")
            .ifPresent(deps -> {
                System.out.println("Found dependencies element");
                
                // Stream-based navigation
                deps.findChildren("dependency")
                    .forEach(dep -> {
                        dep.findChild("groupId")
                            .ifPresent(groupId -> 
                                System.out.println("  GroupId: " + groupId.getTextContent()));
                    });
            });
