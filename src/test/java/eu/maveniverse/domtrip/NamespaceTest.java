...
public class NamespaceTest {
    ...
    void testNamespaceAwareNavigation() {
        ...
        List<Element> metaTitles = root.descendantsByNamespace("http://example.com/meta", "title")
            .collect(Collectors.toList());
    ...
    void testBuiltInNamespaces() {
        ...
        assertEquals("http://www.w3.org/XML/1998/namespace", 
                    NamespaceResolver.resolveNamespaceURI(element, "xml"));
        
        // Test built-in XMLNS namespace
        assertEquals("http://www.w3.org/2000/xmlns/", 
                    NamespaceResolver.resolveNamespaceURI(element, "xmlns"));
