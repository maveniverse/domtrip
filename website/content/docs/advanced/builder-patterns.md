...
description: DomTrip provides fluent builder APIs that make creating and modifying XML structures intuitive and type-safe
layout: page
---
...
- 🌐 [Namespace Support](/docs/features/namespace-support/) - Working with namespaces
- ⚙️ [Configuration](/docs/api/configuration/) - Customizing DomTrip behavior
