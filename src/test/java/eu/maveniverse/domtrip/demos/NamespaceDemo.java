...
public class NamespaceDemo {
    ...
    private static void demonstrateNamespaceResolution() {
        ...
        root.findChildByNamespace("http://example.com/default", "child")
            .ifPresent(child -> {
                System.out.println("\nFound child in default namespace: " + child.getName());
                
                child.findChildByNamespace("http://example.com/ns1", "element")
                    .ifPresent(ns1Element -> {
                        ...
                        ns1Element.findChildByNamespace("http://example.com/ns2", "data")
                            .ifPresent(ns2Data -> {
    ...
    private static void demonstrateNamespaceContext() {
        ...
        root.findChild("child").ifPresent(child -> {
            ...
            System.out.println("  URI 'http://example.com/a' has prefix: " + childContext.getPrefix("http://example.com/a"));
        });
    ...
    private static void demonstrateComplexNamespaceDocument() {
        ...
        soapEnvelope.descendantsByNamespace("http://schemas.xmlsoap.org/soap/envelope/", "Body")
            .findFirst()
            .ifPresent(soapBody -> {
                ...
                soapBody.findChildByNamespace("http://example.com/userservice", "GetUserInfo")
                    .ifPresent(method -> {
                        ...
                        method.findChildByNamespace("http://example.com/userservice", "userId")
                            .ifPresent(userId -> System.out.println("  User ID: " + userId.getTextContent()));
                    });
            });
        System.out.println();
    }
